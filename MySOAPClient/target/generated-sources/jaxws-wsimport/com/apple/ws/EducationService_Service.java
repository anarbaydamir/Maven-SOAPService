 ...
 * 
 */
@WebServiceClient(name = "EducationService", targetNamespace = "http://education.ws.company.com/", wsdlLocation = "http://localhost:10223/MySOAPServiceEyYar/EducationService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EDUCATIONSERVICE_QNAME = new QName("http://education.ws.company.com/", "EducationService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:10223/MySOAPServiceEyYar/EducationService?wsdl");
    ...
    public EducationService getEducationServicePort() {
        return super.getPort(new QName("http://education.ws.company.com/", "EducationServicePort"), EducationService.class);
    }
    ...
    public EducationService getEducationServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://education.ws.company.com/", "EducationServicePort"), EducationService.class, features);
    }
